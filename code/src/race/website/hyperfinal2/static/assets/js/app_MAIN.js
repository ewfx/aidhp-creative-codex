...
//	      center: {lat: 52.632469, lng: -1.689423},
    ...
    center: {lat: 19.069273, lng: 72.869906},
    styles: mapStyle,
  });
    ...
    var featuresa = {
        dominos:
        {
            positionM: new google.maps.LatLng(19.065100, 72.860633),
        ...
        BigBazaar:
        {
            positionM: new google.maps.LatLng(19.032587, 72.846006),
        ...
        bookmyshow:
        {
            positionM: new google.maps.LatLng(19.061230, 72.836847),
        ...
        Marks:
        {
            positionM: new google.maps.LatLng(19.056294, 72.833913),
        ...
        Naturals:
        {
            positionM: new google.maps.LatLng(19.077681, 72.862948),
    ...
    for (var i = 0; i < words.length - 1; i++) {
        ...
        if (words[j].match(/Marks/gi)) {
            ...
            var markandspencersM = { lat: 19.056436, lng: 72.833908 };
            var markandspencersD = { lat: 19.056436, lng: 72.833908 };
            ...
            markerM.addListener('click', function () {
                infowindowa.open(map, markerM);
            });
            markerD.addListener('click', function () {
                infowindowa.open(map, markerD);
            });
